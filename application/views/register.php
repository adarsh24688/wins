    ...
    <div class="horizontalMenucontainer">
        ...
        <div class="header-main">
            ...
            <div id="sticky-wrapper" class="sticky-wrapper" style="height: 64px;">
                <div class="horizontal-main bg-dark-transparent clearfix" style="width: 1903px;">
            ...
            <div class="single-page">
                <div class="col-lg-5 col-xl-4 col-md-6 d-block mx-auto">
                    <div class="wrapper wrapper2">
                        <form id="login" class="card-body" tabindex="500" method="post" action="<?php echo base_url();?>index.php/Home/registerUser" autocomplete="off">
                            <h3>Register</h3>
                            <div class="mail">
